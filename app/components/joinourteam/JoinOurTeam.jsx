                ...
                <div>
                  <ul>
                    <li className='top-bar-item fs-2 justify-content-center  mb-4'>
                      <Link href='mailto:contact@inheritx.com' className='mb-0 fs-1 d-inline-flex align-items-center gap-2' target='_blank'>
                  ...
                  <ul className='lh-45 fw-6'>
                    <li className='top-bar-item fs-2 justify-content-center'>
                      <Link href='https://wa.me/918487006480?text=Hello%20InheritX%2C%20I%27d%20like%20to%20get%20in%20touch.' className='mb-0 fs-1 d-inline-flex align-items-center gap-2' target='_blank' rel='noopener noreferrer'>
