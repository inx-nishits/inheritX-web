export const projectItems = [
  {
    ...
    features: [
      ...
      "Explore & Compare",
      "Book venues by area, budget, type",
      "Virtual tours",
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      "Smart Milk Ordering and Delivery App",
  ...
  },
  {
    ...
    description:
      "Koradream is a mobile application designed to connect football players, scouts, and clubs on one unified platform. The app empowers players to create profiles, upload match highlights, and get discovered by professional scouts worldwide.",
